...
python 5_1_generate_train_data.py $out_dir/json $in_file $variants $out_dir/train_json $out_dir/function_info.json $out_dir/ir
python 6_json2rawtext.py $out_dir/train_json $in_file $variants $out_dir/result ../data-bin/pretrain/inst_dict.txt ../data-bin/pretrain/state_dict.txt $max_len
